...
Bạn được giao nhiệm vụ xây dựng một hệ thống recommendation cho một nền tảng (có thể chọn một trong các loại sau hoặc đề xuất):
...
Đóng thành file zip với quy tắc đặt tên: TenSV\_maSV\_finalProject.zip
